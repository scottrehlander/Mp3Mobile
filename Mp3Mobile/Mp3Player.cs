...
namespace MediaMobile
{
    ...
    class SerialLCDMp3 : Mp3Player
    {
        ...
        public bool InMenu { get { return inMenu; } set { inMenu = value; SerialLCDInterface.SerialLCDInterface.PauseScroll = value; } }

        public SerialLCDMp3()
        {
            SerialLCDInterface.SerialLCDInterface.InitializeDevice(3);
            //Simluation string
        ...
        {
            if (!timeElapsed.Equals(lastTimeRecorded) && !inMenu)
            {
        ...
        public void UpdateScreen()
        {
            ...
            if (currentMedia.Equals("")) { SerialLCDInterface.SerialLCDInterface.DisplayString(SerialLCDInterface.SerialLCDInterface.RowMemoryAddress.Splash); return; }
